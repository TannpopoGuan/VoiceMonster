...
@onready var feedback_label = get_node("/root/Level2/GameManager/FeedbackLabel")  # Reference to feedback label
var SpeechRecognizer

# Called when the node enters the scene tree for the first time.
func _ready() -> void:
	SpeechRecognizer = get_node("/root/Level2/GameManager/SpeechRecognizer")
